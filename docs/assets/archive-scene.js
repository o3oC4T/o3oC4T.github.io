...
void main() {
	...
	#include <colorspace_fragment>
	#include <fog_fragment>
}`},$={common:{diffuse:{value:new Z(16777215)},opacity:{value:1},map:{value:null},mapTransform:{value:new J},alphaMap:{value:null},alphaMapTransform:{value:new J},alphaTest:{value:0}},specularmap:{specularMap:{value:null},specularMapTransform:{value:new J}},envmap:{envMap:{value:null},envMapRotation:{value:new J},reflectivity:{value:1},ior:{value:1.5},refractionRatio:{value:.98},dfgLUT:{value:null}},aomap:{aoMap:{value:null},aoMapIntensity:{value:1},aoMapTransform:{value:new J}},lightmap:{lightMap:{value:null},lightMapIntensity:{value:1},lightMapTransform:{value:new J}},bumpmap:{bumpMap:{value:null},bumpMapTransform:{value:new J},bumpScale:{value:1}},normalmap:{normalMap:{value:null},normalMapTransform:{value:new J},normalScale:{value:new K(1,1)}},displacementmap:{displacementMap:{value:null},displacementMapTransform:{value:new J},displacementScale:{value:1},displacementBias:{value:0}},emissivemap:{emissiveMap:{value:null},emissiveMapTransform:{value:new J}},metalnessmap:{metalnessMap:{value:null},metalnessMapTransform:{value:new J}},roughnessmap:{roughnessMap:{value:null},roughnessMapTransform:{value:new J}},gradientmap:{gradientMap:{value:null}},fog:{fogDensity:{value:25e-5},fogNear:{value:1},fogFar:{value:2e3},fogColor:{value:new Z(16777215)}},lights:{ambientLightColor:{value:[]},lightProbe:{value:[]},sunLights:{value:[],properties:{direction:{},color:{}}},sunLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{}}},sunShadowMatrix:{value:[]},sunShadowCascade:{value:[]},directionalLights:{value:[],properties:{direction:{},color:{}}},directionalLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{}}},directionalShadowMatrix:{value:[]},spotLights:{value:[],properties:{color:{},position:{},direction:{},distance:{},coneCos:{},penumbraCos:{},decay:{}}},spotLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{}}},spotLightMap:{value:[]},spotLightMatrix:{value:[]},pointLights:{value:[],properties:{color:{},position:{},decay:{},distance:{}}},pointLightShadows:{value:[],properties:{shadowIntensity:1,shadowBias:{},shadowNormalBias:{},shadowRadius:{},shadowMapSize:{},shadowCameraNear:{},shadowCameraFar:{}}},pointShadowMatrix:{value:[]},hemisphereLights:{value:[],properties:{direction:{},skyColor:{},groundColor:{}}},rectAreaLights:{value:[],properties:{color:{},position:{},width:{},height:{}}},ltc_1:{value:null},ltc_2:{value:null},probesSH:{value:null},probesMin:{value:new q},probesMax:{value:new q},probesResolution:{value:new q}},points:{diffuse:{value:new Z(16777215)},opacity:{value:1},size:{value:1},scale:{value:1},map:{value:null},alphaMap:{value:null},alphaMapTransform:{value:new J},alphaTest:{value:0},uvTransform:{value:new J}},sprite:{diffuse:{value:new Z(16777215)},opacity:{value:1},center:{value:new K(.5,.5)},rotation:{value:0},map:{value:null},mapTransform:{value:new J},alphaMap:{value:null},alphaMapTransform:{value:new J},alphaTest:{value:0}}},ys={basic:{uniforms:Ga([$.common,$.specularmap,$.envmap,$.aomap,$.lightmap,$.fog]),vertexShader:Q.meshbasic_vert,fragmentShader:Q.meshbasic_frag},lambert:{uniforms:Ga([$.common,$.specularmap,$.envmap,$.aomap,$.lightmap,$.emissivemap,$.bumpmap,$.normalmap,$.displacementmap,$.fog,$.lights,{emissive:{value:new Z(0)},envMapIntensity:{value:1}}]),vertexShader:Q.meshlambert_vert,fragmentShader:Q.meshlambert_frag},phong:{uniforms:Ga([$.common,$.specularmap,$.envmap,$.aomap,$.lightmap,$.emissivemap,$.bumpmap,$.normalmap,$.displacementmap,$.fog,$.lights,{emissive:{value:new Z(0)},specular:{value:new Z(1118481)},shininess:{value:30},envMapIntensity:{value:1}}]),vertexShader:Q.meshphong_vert,fragmentShader:Q.meshphong_frag},standard:{uniforms:Ga([$.common,$.envmap,$.aomap,$.lightmap,$.emissivemap,$.bumpmap,$.normalmap,$.displacementmap,$.roughnessmap,$.metalnessmap,$.fog,$.lights,{emissive:{value:new Z(0)},roughness:{value:1},metalness:{value:0},envMapIntensity:{value:1}}]),vertexShader:Q.meshphysical_vert,fragmentShader:Q.meshphysical_frag},toon:{uniforms:Ga([$.common,$.aomap,$.lightmap,$.emissivemap,$.bumpmap,$.normalmap,$.displacementmap,$.gradientmap,$.fog,$.lights,{emissive:{value:new Z(0)}}]),vertexShader:Q.meshtoon_vert,fragmentShader:Q.meshtoon_frag},matcap:{uniforms:Ga([$.common,$.bumpmap,$.normalmap,$.displacementmap,$.fog,{matcap:{value:null}}]),vertexShader:Q.meshmatcap_vert,fragmentShader:Q.meshmatcap_frag},points:{uniforms:Ga([$.points,$.fog]),vertexShader:Q.points_vert,fragmentShader:Q.points_frag},dashed:{uniforms:Ga([$.common,$.fog,{scale:{value:1},dashSize:{value:1},totalSize:{value:2}}]),vertexShader:Q.linedashed_vert,fragmentShader:Q.linedashed_frag},depth:{uniforms:Ga([$.common,$.displacementmap]),vertexShader:Q.depth_vert,fragmentShader:Q.depth_frag},normal:{uniforms:Ga([$.common,$.bumpmap,$.normalmap,$.displacementmap,{opacity:{value:1}}]),vertexShader:Q.meshnormal_vert,fragmentShader:Q.meshnormal_frag},sprite:{uniforms:Ga([$.sprite,$.fog]),vertexShader:Q.sprite_vert,fragmentShader:Q.sprite_frag},background:{uniforms:{uvTransform:{value:new J},t2D:{value:null},backgroundIntensity:{value:1}},vertexShader:Q.background_vert,fragmentShader:Q.background_frag},backgroundCube:{uniforms:{envMap:{value:null},backgroundBlurriness:{value:0},backgroundIntensity:{value:1},backgroundRotation:{value:new J}},vertexShader:Q.backgroundCube_vert,fragmentShader:Q.backgroundCube_frag},cube:{uniforms:{tCube:{value:null},tFlip:{value:-1},opacity:{value:1}},vertexShader:Q.cube_vert,fragmentShader:Q.cube_frag},equirect:{uniforms:{tEquirect:{value:null}},vertexShader:Q.equirect_vert,fragmentShader:Q.equirect_frag},distance:{uniforms:Ga([$.common,$.displacementmap,{referencePosition:{value:new q},nearDistance:{value:1},farDistance:{value:1e3}}]),vertexShader:Q.distance_vert,fragmentShader:Q.distance_frag},shadow:{uniforms:Ga([$.lights,$.fog,{color:{value:new Z(0)},opacity:{value:1}}]),vertexShader:Q.shadow_vert,fragmentShader:Q.shadow_frag}};ys.physical={uniforms:Ga([ys.standard.uniforms,{clearcoat:{value:0},clearcoatMap:{value:null},clearcoatMapTransform:{value:new J},clearcoatNormalMap:{value:null},clearcoatNormalMapTransform:{value:new J},clearcoatNormalScale:{value:new K(1,1)},clearcoatRoughness:{value:0},clearcoatRoughnessMap:{value:null},clearcoatRoughnessMapTransform:{value:new J},dispersion:{value:0},retroreflectivity:{value:0},iridescence:{value:0},iridescenceMap:{value:null},iridescenceMapTransform:{value:new J},iridescenceIOR:{value:1.3},iridescenceThicknessMinimum:{value:100},iridescenceThicknessMaximum:{value:400},iridescenceThicknessMap:{value:null},iridescenceThicknessMapTransform:{value:new J},sheen:{value:0},sheenColor:{value:new Z(0)},sheenColorMap:{value:null},sheenColorMapTransform:{value:new J},sheenRoughness:{value:1},sheenRoughnessMap:{value:null},sheenRoughnessMapTransform:{value:new J},transmission:{value:0},transmissionMap:{value:null},transmissionMapTransform:{value:new J},transmissionSamplerSize:{value:new K},transmissionSamplerMap:{value:null},thickness:{value:0},thicknessMap:{value:null},thicknessMapTransform:{value:new J},attenuationDistance:{value:0},attenuationColor:{value:new Z(0)},specularColor:{value:new Z(1,1,1)},specularColorMap:{value:null},specularColorMapTransform:{value:new J},specularIntensity:{value:1},specularIntensityMap:{value:null},specularIntensityMapTransform:{value:new J},anisotropyVector:{value:new K},anisotropyMap:{value:null},anisotropyMapTransform:{value:new J}}]),vertexShader:Q.meshphysical_vert,fragmentShader:Q.meshphysical_frag};var bs={r:0,b:0,g:0},xs=new Yt,Ss=new J;Ss.set(-1,0,0,0,1,0,0,0,1);function Cs(e,t,n,r,i,a){let o=new Z(0),s=i===!0?0:1,c,l,u=null,d=0,f=null;function p(e){let n=e.isScene===!0?e.background:null;if(n&&n.isTexture){let r=e.backgroundBlurriness>0;n=t.get(n,r)}return n}function m(t){let r=!1,i=p(t);i===null?g(o,s):i&&i.isColor&&(g(i,1),r=!0);let c=e.xr.getEnvironmentBlendMode();c===`additive`?n.buffers.color.setClear(0,0,0,1,a):c===`alpha-blend`&&n.buffers.color.setClear(0,0,0,0,a),(e.autoClear||r)&&(n.buffers.depth.setTest(!0),n.buffers.depth.setMask(!0),n.buffers.color.setMask(!0),e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil))}function h(t,n){let i=p(n);i&&(i.isCubeTexture||i.mapping===306)?(l===void 0&&(l=new ni(new wi(1,1,1),new Qa({name:`BackgroundCubeMaterial`,uniforms:Wa(ys.backgroundCube.uniforms),vertexShader:ys.backgroundCube.vertexShader,fragmentShader:ys.backgroundCube.fragmentShader,side:1,depthTest:!1,depthWrite:!1,fog:!1,allowOverride:!1})),l.geometry.deleteAttribute(`normal`),l.geometry.deleteAttribute(`uv`),l.onBeforeRender=function(e,t,n){this.matrixWorld.copyPosition(n.matrixWorld)},Object.defineProperty(l.material,`envMap`,{get:function(){return this.uniforms.envMap.value}}),r.update(l)),l.material.uniforms.envMap.value=i,l.material.uniforms.backgroundBlurriness.value=n.backgroundBlurriness,l.material.uniforms.backgroundIntensity.value=n.backgroundIntensity,l.material.uniforms.backgroundRotation.value.setFromMatrix4(xs.makeRotationFromEuler(n.backgroundRotation)).transpose(),i.isCubeTexture&&i.isRenderTargetTexture===!1&&l.material.uniforms.backgroundRotation.value.premultiply(Ss),l.material.toneMapped=X.getTransfer(i.colorSpace)!==Be,(u!==i||d!==i.version||f!==e.toneMapping)&&(l.material.needsUpdate=!0,u=i,d=i.version,f=e.toneMapping),l.layers.enableAll(),t.unshift(l,l.geometry,l.material,0,0,null)):i&&i.isTexture&&(c===void 0&&(c=new ni(new Ua(2,2),new Qa({name:`BackgroundMaterial`,uniforms:Wa(ys.background.uniforms),vertexShader:ys.background.vertexShader,fragmentShader:ys.background.fragmentShader,side:0,depthTest:!1,depthWrite:!1,fog:!1,allowOverride:!1})),c.geometry.deleteAttribute(`normal`),Object.defineProperty(c.material,`map`,{get:function(){return this.uniforms.t2D.value}}),r.update(c)),c.material.uniforms.t2D.value=i,c.material.uniforms.backgroundIntensity.value=n.backgroundIntensity,c.material.toneMapped=X.getTransfer(i.colorSpace)!==Be,i.matrixAutoUpdate===!0&&i.updateMatrix(),c.material.uniforms.uvTransform.value.copy(i.matrix),(u!==i||d!==i.version||f!==e.toneMapping)&&(c.material.needsUpdate=!0,u=i,d=i.version,f=e.toneMapping),c.layers.enableAll(),t.unshift(c,c.geometry,c.material,0,0,null))}function g(t,r){t.getRGB(bs,Ja(e)),n.buffers.color.setClear(bs.r,bs.g,bs.b,r,a)}function _(){l!==void 0&&(l.geometry.dispose(),l.material.dispose(),l=void 0),c!==void 0&&(c.geometry.dispose(),c.material.dispose(),c=void 0)}return{getClearColor:function(){return o},setClearColor:function(e,t=1){o.set(e),s=t,g(o,s)},getClearAlpha:function(){return s},setClearAlpha:function(e){s=e,g(o,s)},render:m,addToRenderList:h,dispose:_}}function ws(e,t){let n=e.getParameter(e.MAX_VERTEX_ATTRIBS),r={},i=f(null),a=i,o=!1;function s(n,r,i,s,c){let u=!1,f=d(n,s,i,r);a!==f&&(a=f,l(a.object)),u=p(n,s,i,c),u&&m(n,s,i,c),c!==null&&t.update(c,e.ELEMENT_ARRAY_BUFFER),(u||o)&&(o=!1,b(n,r,i,s),c!==null&&e.bindBuffer(e.ELEMENT_ARRAY_BUFFER,t.get(c).buffer))}function c(){return e.createVertexArray()}function l(t){return e.bindVertexArray(t)}function u(t){return e.deleteVertexArray(t)}function d(e,t,n,i){let a=i.wireframe===!0,o=r[t.id];o===void 0&&(o={},r[t.id]=o);let s=e.isInstancedMesh===!0?e.id:0,l=o[s];l===void 0&&(l={},o[s]=l);let u=l[n.id];u===void 0&&(u={},l[n.id]=u);let d=u[a];return d===void 0&&(d=f(c()),u[a]=d),d}function f(e){let t=[],r=[],i=[];for(let e=0;e<n;e++)t[e]=0,r[e]=0,i[e]=0;return{geometry:null,program:null,wireframe:!1,newAttributes:t,enabledAttributes:r,attributeDivisors:i,object:e,attributes:{},index:null}}function p(e,t,n,r){let i=a.attributes,o=t.attributes,s=0,c=n.getAttributes();for(let t in c)if(c[t].location>=0){let n=i[t],r=o[t];if(r===void 0&&(t===`instanceMatrix`&&e.instanceMatrix&&(r=e.instanceMatrix),t===`instanceColor`&&e.instanceColor&&(r=e.instanceColor)),n===void 0||n.attribute!==r||r&&n.data!==r.data)return!0;s++}return a.attributesNum!==s||a.index!==r}function m(e,t,n,r){let i={},o=t.attributes,s=0,c=n.getAttributes();for(let t in c)if(c[t].location>=0){let n=o[t];n===void 0&&(t===`instanceMatrix`&&e.instanceMatrix&&(n=e.instanceMatrix),t===`instanceColor`&&e.instanceColor&&(n=e.instanceColor));let r={};r.attribute=n,n&&n.data&&(r.data=n.data),i[t]=r,s++}a.attributes=i,a.attributesNum=s,a.index=r}function h(){let e=a.newAttributes;for(let t=0,n=e.length;t<n;t++)e[t]=0}function g(e){_(e,0)}function _(t,n){let r=a.newAttributes,i=a.enabledAttributes,o=a.attributeDivisors;r[t]=1,i[t]===0&&(e.enableVertexAttribArray(t),i[t]=1),o[t]!==n&&(e.vertexAttribDivisor(t,n),o[t]=n)}function v(){let t=a.newAttributes,n=a.enabledAttributes;for(let r=0,i=n.length;r<i;r++)n[r]!==t[r]&&(e.disableVertexAttribArray(r),n[r]=0)}function y(t,n,r,i,a,o,s){s===!0?e.vertexAttribIPointer(t,n,r,a,o):e.vertexAttribPointer(t,n,r,i,a,o)}function b(n,r,i,a){h();let o=a.attributes,s=i.getAttributes(),c=r.defaultAttributeValues;for(let r in s){let i=s[r];if(i.location>=0){let s=o[r];if(s===void 0&&(r===`instanceMatrix`&&n.instanceMatrix&&(s=n.instanceMatrix),r===`instanceColor`&&n.instanceColor&&(s=n.instanceColor)),s!==void 0){let r=s.normalized,o=s.itemSize,c=t.get(s);if(c===void 0)continue;let l=c.buffer,u=c.type,d=c.bytesPerElement,f=u===e.INT||u===e.UNSIGNED_INT||s.gpuType===1013;if(s.isInterleavedBufferAttribute){let t=s.data,c=t.stride,p=s.offset;if(t.isInstancedInterleavedBuffer){for(let e=0;e<i.locationSize;e++)_(i.location+e,t.meshPerAttribute);n.isInstancedMesh!==!0&&a._maxInstanceCount===void 0&&(a._maxInstanceCount=t.meshPerAttribute*t.count)}else for(let e=0;e<i.locationSize;e++)g(i.location+e);e.bindBuffer(e.ARRAY_BUFFER,l);for(let e=0;e<i.locationSize;e++)y(i.location+e,o/i.locationSize,u,r,c*d,(p+o/i.locationSize*e)*d,f)}else{if(s.isInstancedBufferAttribute){for(let e=0;e<i.locationSize;e++)_(i.location+e,s.meshPerAttribute);n.isInstancedMesh!==!0&&a._maxInstanceCount===void 0&&(a._maxInstanceCount=s.meshPerAttribute*s.count)}else for(let e=0;e<i.locationSize;e++)g(i.location+e);e.bindBuffer(e.ARRAY_BUFFER,l);for(let e=0;e<i.locationSize;e++)y(i.location+e,o/i.locationSize,u,r,o*d,o/i.locationSize*e*d,f)}}else if(c!==void 0){let t=c[r];if(t!==void 0)switch(t.length){case 2:e.vertexAttrib2fv(i.location,t);break;case 3:e.vertexAttrib3fv(i.location,t);break;case 4:e.vertexAttrib4fv(i.location,t);break;default:e.vertexAttrib1fv(i.location,t)}}}}v()}function x(){T();for(let e in r){let t=r[e];for(let e in t){let n=t[e];for(let e in n){let t=n[e];for(let e in t)u(t[e].object),delete t[e];delete n[e]}}delete r[e]}}function S(e){if(r[e.id]===void 0)return;let t=r[e.id];for(let e in t){let n=t[e];for(let e in n){let t=n[e];for(let e in t)u(t[e].object),delete t[e];delete n[e]}}delete r[e.id]}function C(e){for(let t in r){let n=r[t];for(let t in n){let r=n[t];if(r[e.id]===void 0)continue;let i=r[e.id];for(let e in i)u(i[e].object),delete i[e];delete r[e.id]}}}function w(e){for(let t in r){let n=r[t],i=e.isInstancedMesh===!0?e.id:0,a=n[i];if(a!==void 0){for(let e in a){let t=a[e];for(let e in t)u(t[e].object),delete t[e];delete a[e]}delete n[i],Object.keys(n).length===0&&delete r[t]}}}function T(){E(),o=!0,a!==i&&(a=i,l(a.object))}function E(){i.geometry=null,i.program=null,i.wireframe=!1}return{setup:s,reset:T,resetDefaultState:E,dispose:x,releaseStatesOfGeometry:S,releaseStatesOfObject:w,releaseStatesOfProgram:C,initAttributes:h,enableAttribute:g,disableUnusedAttributes:v}}function Ts(e,t,n){let r;function i(e){r=e}function a(t,i){e.drawArrays(r,t,i),n.update(i,r,1)}function o(t,i,a){a!==0&&(e.drawArraysInstanced(r,t,i,a),n.update(i,r,a))}function s(e,i,a){if(a===0)return;t.get(`WEBGL_multi_draw`).multiDrawArraysWEBGL(r,e,0,i,0,a);let o=0;for(let e=0;e<a;e++)o+=i[e];n.update(o,r,1)}this.setMode=i,this.render=a,this.renderInstances=o,this.renderMultiDraw=s}function Es(e,t,n,r){let i;function a(){if(i!==void 0)return i;if(t.has(`EXT_texture_filter_anisotropic`)===!0){let n=t.get(`EXT_texture_filter_anisotropic`);i=e.getParameter(n.MAX_TEXTURE_MAX_ANISOTROPY_EXT)}else i=0;return i}function o(t){return!(t!==1023&&r.convert(t)!==e.getParameter(e.IMPLEMENTATION_COLOR_READ_FORMAT))}function s(n){let i=n===1016&&(t.has(`EXT_color_buffer_half_float`)||t.has(`EXT_color_buffer_float`));return!(n!==1009&&n!==1015&&!i&&r.convert(n)!==e.getParameter(e.IMPLEMENTATION_COLOR_READ_TYPE))}function c(t){if(t===`highp`){if(e.getShaderPrecisionFormat(e.VERTEX_SHADER,e.HIGH_FLOAT).precision>0&&e.getShaderPrecisionFormat(e.FRAGMENT_SHADER,e.HIGH_FLOAT).precision>0)return`highp`;t=`mediump`}return t===`mediump`&&e.getShaderPrecisionFormat(e.VERTEX_SHADER,e.MEDIUM_FLOAT).precision>0&&e.getShaderPrecisionFormat(e.FRAGMENT_SHADER,e.MEDIUM_FLOAT).precision>0?`mediump`:`lowp`}let l=n.precision===void 0?`highp`:n.precision,u=c(l);u!==l&&(U(`WebGLRenderer:`,l,`not supported, using`,u,`instead.`),l=u);let d=n.logarithmicDepthBuffer===!0,f=n.reversedDepthBuffer===!0&&t.has(`EXT_clip_control`);n.reversedDepthBuffer===!0&&f===!1&&U(`WebGLRenderer: Unable to use reversed depth buffer due to missing EXT_clip_control extension. Fallback to default depth buffer.`);let p=e.getParameter(e.MAX_TEXTURE_IMAGE_UNITS),m=e.getParameter(e.MAX_VERTEX_TEXTURE_IMAGE_UNITS),h=e.getParameter(e.MAX_TEXTURE_SIZE),g=e.getParameter(e.MAX_CUBE_MAP_TEXTURE_SIZE),_=e.getParameter(e.MAX_VERTEX_ATTRIBS),v=e.getParameter(e.MAX_VERTEX_UNIFORM_VECTORS),y=e.getParameter(e.MAX_VARYING_VECTORS),b=e.getParameter(e.MAX_FRAGMENT_UNIFORM_VECTORS),x=e.getParameter(e.MAX_SAMPLES),S=e.getParameter(e.SAMPLES);return{isWebGL2:!0,getMaxAnisotropy:a,getMaxPrecision:c,textureFormatReadable:o,textureTypeReadable:s,precision:l,logarithmicDepthBuffer:d,reversedDepthBuffer:f,maxTextures:p,maxVertexTextures:m,maxTextureSize:h,maxCubemapSize:g,maxAttributes:_,maxVertexUniforms:v,maxVaryings:y,maxFragmentUniforms:b,maxSamples:x,samples:S}}function Ds(e){let t=this,n=null,r=0,i=!1,a=!1,o=new Ir,s=new J,c={value:null,needsUpdate:!1};this.uniform=c,this.numPlanes=0,this.numIntersection=0,this.init=function(e,t){let n=e.length!==0||t||r!==0||i;return i=t,r=e.length,n},this.beginShadows=function(){a=!0,u(null)},this.endShadows=function(){a=!1},this.setGlobalState=function(e,t){n=u(e,t,0)},this.setState=function(t,o,s){let d=t.clippingPlanes,f=t.clipIntersection,p=t.clipShadows,m=e.get(t);if(!i||d===null||d.length===0||a&&!p)a?u(null):l();else{let e=a?0:r,t=e*4,i=m.clippingState||null;c.value=i,i=u(d,o,t,s);for(let e=0;e!==t;++e)i[e]=n[e];m.clippingState=i,this.numIntersection=f?this.numPlanes:0,this.numPlanes+=e}};function l(){c.value!==n&&(c.value=n,c.needsUpdate=r>0),t.numPlanes=r,t.numIntersection=0}function u(e,n,r,i){let a=e===null?0:e.length,l=null;if(a!==0){if(l=c.value,i!==!0||l===null){let t=r+a*4,i=n.matrixWorldInverse;s.getNormalMatrix(i),(l===null||l.length<t)&&(l=new Float32Array(t));for(let t=0,n=r;t!==a;++t,n+=4)o.copy(e[t]).applyMatrix4(i,s),o.normal.toArray(l,n),l[n+3]=o.constant}c.value=l,c.needsUpdate=!0}return t.numPlanes=a,t.numIntersection=0,l}}var Os=4,ks=6,As=20,js=256,Ms=new Uo,Ns=new Z,Ps=null,Fs=0,Is=0,Ls=!1,Rs=new q,zs=new q,Bs=class{constructor(e){this._renderer=e,this._pingPongRenderTarget=null,this._lodMax=0,this._cubeSize=0,this._sizeLods=[],this._lodMeshes=[],this._backgroundBox=null,this._cubemapMaterial=null,this._equirectMaterial=null,this._blurMaterial=null,this._ggxMaterial=null}fromScene(e,t=0,n=.1,r=100,i={}){let{size:a=256,position:o=Rs}=i;Ps=this._renderer.getRenderTarget(),Fs=this._renderer.getActiveCubeFace(),Is=this._renderer.getActiveMipmapLevel(),Ls=this._renderer.xr.enabled,this._renderer.xr.enabled=!1,this._setSize(a);let s=this._allocateTargets();return s.depthBuffer=!0,this._sceneToCubeUV(e,n,r,s,o),t>0&&this._blur(s,0,0,t),this._applyPMREM(s),this._cleanup(s),s}fromEquirectangular(e,t=null){return this._fromTexture(e,t)}fromCubemap(e,t=null){return this._fromTexture(e,t)}compileCubemapShader(){this._cubemapMaterial===null&&(this._cubemapMaterial=qs(),this._compileMaterial(this._cubemapMaterial))}compileEquirectangularShader(){this._equirectMaterial===null&&(this._equirectMaterial=Ks(),this._compileMaterial(this._equirectMaterial))}dispose(){this._dispose(),this._cubemapMaterial!==null&&this._cubemapMaterial.dispose(),this._equirectMaterial!==null&&this._equirectMaterial.dispose(),this._backgroundBox!==null&&(this._backgroundBox.geometry.dispose(),this._backgroundBox.material.dispose())}_setSize(e){this._lodMax=Math.floor(Math.log2(e)),this._cubeSize=2**this._lodMax}_dispose(){this._blurMaterial!==null&&this._blurMaterial.dispose(),this._ggxMaterial!==null&&this._ggxMaterial.dispose(),this._pingPongRenderTarget!==null&&this._pingPongRenderTarget.dispose();for(let e=0;e<this._lodMeshes.length;e++)this._lodMeshes[e].geometry.dispose()}_cleanup(e){this._renderer.setRenderTarget(Ps,Fs,Is),this._renderer.xr.enabled=Ls,e.scissorTest=!1,Us(e,0,0,e.width,e.height)}_fromTexture(e,t){e.mapping===301||e.mapping===302?this._setSize(e.image.length===0?16:e.image[0].width||e.image[0].image.width):this._setSize(e.image.width/4),Ps=this._renderer.getRenderTarget(),Fs=this._renderer.getActiveCubeFace(),Is=this._renderer.getActiveMipmapLevel(),Ls=this._renderer.xr.enabled,this._renderer.xr.enabled=!1;let n=t||this._allocateTargets();return this._textureToCubeUV(e,n),this._applyPMREM(n),this._cleanup(n),n}_allocateTargets(){let e=3*Math.max(this._cubeSize,112),t=4*this._cubeSize,n={magFilter:u,minFilter:u,generateMipmaps:!1,type:b,format:O,colorSpace:Re,depthBuffer:!1},r=Hs(e,t,n);if(this._pingPongRenderTarget===null||this._pingPongRenderTarget.width!==e||this._pingPongRenderTarget.height!==t){this._pingPongRenderTarget!==null&&this._dispose(),this._pingPongRenderTarget=Hs(e,t,n);let{_lodMax:r}=this;({lodMeshes:this._lodMeshes,sizeLods:this._sizeLods}=Vs(r)),this._blurMaterial=Gs(r,e,t),this._ggxMaterial=Ws(r,e,t)}return r}_compileMaterial(e){let t=new ni(new Mr,e);this._renderer.compile(t,Ms)}_sceneToCubeUV(e,t,n,r,i){let a=new Bo(90,1,t,n),o=[1,-1,1,1,1,1],s=[1,1,1,-1,-1,-1],c=this._renderer,l=c.autoClear,u=c.toneMapping;c.getClearColor(Ns),c.toneMapping=0,c.autoClear=!1,c.state.buffers.depth.getReversed()&&(c.setRenderTarget(r),c.clearDepth(),c.setRenderTarget(null)),this._backgroundBox===null&&(this._backgroundBox=new ni(new wi,new Wr({name:`PMREM.Background`,side:1,depthWrite:!1,depthTest:!1})));let d=this._backgroundBox,f=d.material,p=!1,m=e.background;m?m.isColor&&(f.color.copy(m),e.background=null,p=!0):(f.color.copy(Ns),p=!0);for(let t=0;t<6;t++){let n=t%3;n===0?(a.up.set(0,o[t],0),a.position.set(i.x,i.y,i.z),a.lookAt(i.x+s[t],i.y,i.z)):n===1?(a.up.set(0,0,o[t]),a.position.set(i.x,i.y,i.z),a.lookAt(i.x,i.y+s[t],i.z)):(a.up.set(0,o[t],0),a.position.set(i.x,i.y,i.z),a.lookAt(i.x,i.y,i.z+s[t]));let l=this._cubeSize;Us(r,n*l,t>2?l:0,l,l),c.setRenderTarget(r),p&&c.render(d,a),c.render(e,a)}c.toneMapping=u,c.autoClear=l,e.background=m}_textureToCubeUV(e,t){let n=this._renderer,r=e.mapping===301||e.mapping===302;r?(this._cubemapMaterial===null&&(this._cubemapMaterial=qs()),this._cubemapMaterial.uniforms.flipEnvMap.value=e.isRenderTargetTexture===!1?-1:1):this._equirectMaterial===null&&(this._equirectMaterial=Ks());let i=r?this._cubemapMaterial:this._equirectMaterial,a=this._lodMeshes[0];a.material=i;let o=i.uniforms;o.envMap.value=e;let s=this._cubeSize;Us(t,0,0,3*s,2*s),n.setRenderTarget(t),n.render(a,Ms)}_applyPMREM(e){let t=this._renderer,n=t.autoClear;t.autoClear=!1;let r=this._lodMeshes.length;for(let t=1;t<r;t++)this._applyGGXFilter(e,t-1,t);t.autoClear=n}_applyGGXFilter(e,t,n){let r=this._renderer,i=this._pingPongRenderTarget,a=this._ggxMaterial,o=this._lodMeshes[n];o.material=a;let s=a.uniforms,c=n/(this._lodMeshes.length-1),l=t/(this._lodMeshes.length-1),u=Math.sqrt(c*c-l*l)*(c*1.25),{_lodMax:d}=this,f=this._sizeLods[n],p=3*f*(n>d-Os?n-d+Os:0),m=4*(this._cubeSize-f);s.envMap.value=e.texture,s.roughness.value=u,s.mipInt.value=d-t,Us(i,p,m,3*f,2*f),r.setRenderTarget(i),r.render(o,Ms),s.envMap.value=i.texture,s.roughness.value=0,s.mipInt.value=d-n,Us(e,p,m,3*f,2*f),r.setRenderTarget(e),r.render(o,Ms)}_blur(e,t,n,r){let i=this._pingPongRenderTarget,a=Math.min(r,Math.PI)/Math.SQRT2;this._blurPass(e,i,t,n,a),this._blurPass(i,e,n,n,a)}_blurPass(e,t,n,r,i){let a=this._renderer,o=this._blurMaterial,s=this._lodMeshes[r];s.material=o;let c=o.uniforms;c.envMap.value=e.texture,c.sigma.value=i,c.mipInt.value=this._lodMax-n;let l=this._sizeLods[r];Us(t,3*l*(r>this._lodMax-Os?r-this._lodMax+Os:0),4*(this._cubeSize-l),3*l,2*l),a.setRenderTarget(t),a.render(s,Ms)}};function Vs(e){let t=[],n=[],r=e,i=e-Os+1+ks;for(let e=0;e<i;e++){let e=2**r;t.push(e);let i=1/(e-2),a=-i,o=1+i,s=[a,a,o,a,o,o,a,a,o,o,a,o],c=new Float32Array(108),l=new Float32Array(108);for(let e=0;e<6;e++){let t=e%3*2/3-1,n=e>2?0:-1,r=[t,n,0,t+2/3,n,0,t+2/3,n+1,0,t,n,0,t+2/3,n+1,0,t,n+1,0];c.set(r,18*e);for(let t=0;t<6;t++){let n=s[t*2]*2-1,r=s[t*2+1]*2-1;e===0?zs.set(1,r,n):e===1?zs.set(-n,1,-r):e===2?zs.set(-n,r,1):e===3?zs.set(-1,r,-n):e===4?zs.set(-n,-1,r):zs.set(n,r,-1),zs.toArray(l,(e*6+t)*3)}}let u=new Mr;u.setAttribute(`position`,new _r(c,3)),u.setAttribute(`outputDirection`,new _r(l,3)),n.push(new ni(u,null)),r>Os&&r--}return{lodMeshes:n,sizeLods:t}}function Hs(e,t,n){let r=new Kt(e,t,n);return r.texture.mapping=306,r.texture.name=`PMREM.cubeUv`,r.scissorTest=!0,r}function Us(e,t,n,r,i){e.viewport.set(t,n,r,i),e.scissor.set(t,n,r,i)}function Ws(e,t,n){return new Qa({name:`PMREMGGXConvolution`,defines:{GGX_SAMPLES:js,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},roughness:{value:0},mipInt:{value:0}},vertexShader:Js(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Gs(e,t,n){return new Qa({name:`SphericalGaussianBlur`,defines:{SAMPLES:As,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:Js(),fragmentShader:`
	...
	`}var Ys=class extends Kt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new yi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var bl={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function xl(e,t){let n=bl[t];return n===void 0?(U(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Sl=new q;function Cl(){return X.getLuminanceCoefficients(Sl),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Sl.x.toFixed(4)}, ${Sl.y.toFixed(4)}, ${Sl.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},Bu=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},Vu=new Uo(-1,1,1,-1,0,1),Hu=new class extends Mr{constructor(){super(),this.setAttribute(`position`,new br([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new br([0,2,0,0,2,0],2))}},Uu=class{constructor(e){this._mesh=new ni(Hu,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,Vu)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},Wu=class extends Bu{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof Qa?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=Ya.clone(e.uniforms),this.material=new Qa({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new Uu(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},Gu=class extends Bu{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},Ku=class extends Bu{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},qu=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new K);this._width=n.width,this._height=n.height,t=new Kt(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:b}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new Wu(zu),this.copyPass.material.blending=0,this.timer=new Zo}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}Gu!==void 0&&(r instanceof Gu?n=!0:r instanceof Ku&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new K);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},Ju=class extends Bu{constructor(e,t,n=null,r=null,i=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=i,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new Z}render(e,t,n){let r=e.autoClear;e.autoClear=!1;let i,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(i=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==1&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(i),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}},Yu={name:`LuminosityHighPassShader`,uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new Z(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};Xu.BlurDirectionX=new K(1,0),Xu.BlurDirectionY=new K(0,1);var Zu={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
...
`:``}`+e.fragmentShader,e.fragmentShader=e.fragmentShader.replace(`#include <map_fragment>`,`
          ...
          ${n===`base`?``:`
            ...
            diffuseColor.rgb = mix(diffuseColor.rgb, ink * inkTint, hoverTint * .12);
          `}
          vec4 symbolFill = texture2D(symbolFillMap, vMapUv);
          float nameBand = step(.85, vMapUv.y);
          float inkReveal = mix(symbolFillAmount, hoverTint, nameBand);
          diffuseColor.rgb = mix(diffuseColor.rgb, inkTint * .16, symbolFill.a * inkReveal);
          ${t?`
            float glitchBand = step(.72, fract(gl_FragCoord.y * .085 + glitchAmount * 7.0));
            float glitchSignal = glitchAmount * glitchBand;
            diffuseColor.rgb = mix(diffuseColor.rgb, diffuseColor.bgr, glitchSignal * .28);
            diffuseColor.rgb += normalize(inkTint + vec3(.001)) * glitchSignal * .22;
          `:``}
        `)},g.customProgramCacheKey=()=>n===`rainbow`?`project-hover-name-fill-glitch-v2`:`project-hover-name-fill-v2`;let _=new ni(me,[g,o]);_.castShadow=!0,_.receiveShadow=!1,_.userData.index=r,a.add(_)});let We=new $u(new Ua(100,100),{textureWidth:2048,textureHeight:2048,multisample:4,clipBias:.003,shader:{uniforms:{color:{value:null},tDiffuse:{value:null},textureMatrix:{value:null},grain:{value:A}},vertexShader:`
        uniform mat4 textureMatrix;
        ...
        void main() {
          #include <logdepthbuf_fragment>
          float noise = texture2D(grain, vGrain).r;
          vec2 uv = vReflection.xy / vReflection.w;
          uv += (vec2(noise, texture2D(grain, vGrain + .37).r) - .75) * .00008;
          vec3 reflection = vec3(0.0);
          // Preserve the contact reflection; soften progressively away from the tray.
          vec2 outsideBase = max(abs(vWorld.xz) - vec2(4.1, 2.3), 0.0);
          float spread = .00035 + min(length(outsideBase), 8.0) * .00035;
          for (int x = -1; x <= 1; x++) {
            for (int y = -1; y <= 1; y++) {
              reflection += texture2D(tDiffuse, uv + vec2(float(x), float(y)) * spread).rgb;
            }
          }
          reflection /= 9.0;
          float fade = exp(-.012 * dot(vWorld.xz, vWorld.xz));
          vec3 base = vec3(.0022, .0015, .0024);
          gl_FragColor = vec4(base + reflection * .46 * fade * (.8 + .25 * noise), 1.0);
          #include <tonemapping_fragment>
          #include <colorspace_fragment>
        }`}});We.getRenderTarget().texture.generateMipmaps=!0,We.getRenderTarget().texture.minFilter=f;let Ge=We.onBeforeRender,Ke=-1/0,qe=30;We.onBeforeRender=function(...e){let t=performance.now();t-Ke<qe||(Ke=t,Ge.apply(this,e))},We.rotation.x=-Math.PI/2,We.position.y=-.002,c.add(We);let Je=new ni(new Ua(100,100),new to({color:`#100d13`,roughness:.56,roughnessMap:A,bumpMap:A,bumpScale:.003,metalness:.08,envMapIntensity:.1,transparent:!0,opacity:.6,depthWrite:!1,clearcoat:.12,clearcoatRoughness:.5}));Je.rotation.x=-Math.PI/2,Je.receiveShadow=!0,Je.renderOrder=1,c.add(Je);let Ye=new wn;c.add(Ye);let Xe=new Qa({uniforms:{strength:{value:0}},transparent:!0,depthWrite:!1,vertexShader:`
      varying vec2 contactPoint;
      void main() {
        contactPoint = position.xy;
        gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
      }`,fragmentShader:`
      uniform float strength;
      varying vec2 contactPoint;
      void main() {
        vec2 q = abs(contactPoint) - vec2(4.065, 2.265);
        float distanceToBase = length(max(q, 0.0)) + min(max(q.x, q.y), 0.0) - .025;
        float outside = max(distanceToBase, 0.0);
        float contact = exp(-outside * outside / .0072);
        float penumbra = exp(-outside * outside / .24);
        gl_FragColor = vec4(.001, .0012, .0008, strength * (.66 * contact + .23 * penumbra));
      }`}),Ze=new ni(new Ua(11,7.5),Xe);Ze.rotation.x=-Math.PI/2,Ze.position.y=.008,Ze.renderOrder=3,Ye.add(Ze);let U=document.createElement(`canvas`);U.width=U.height=256;let W=U.getContext(`2d`),Qe=W.createRadialGradient(128,128,0,128,128,128);Qe.addColorStop(0,`rgba(255,173,218,0.07)`),Qe.addColorStop(.32,`rgba(223,139,207,0.025)`),Qe.addColorStop(1,`rgba(138,79,137,0)`),W.fillStyle=Qe,W.fillRect(0,0,256,256);let $e=new bi(U);T.push($e);let et=new Wr({map:$e,transparent:!0,depthWrite:!1,blending:2,toneMapped:!1});for(let e of[-3.8,3.8]){let t=new ni(new Ua(7,7),et);t.rotation.x=-Math.PI/2,t.position.set(e,.004,.6),t.renderOrder=2,Ye.add(t)}let tt=new Oo(`#f7e5f7`,`#170f1b`,0);c.add(tt);let nt=new Go(`#fff1fa`,0);nt.position.set(-3,9,5),nt.castShadow=!0,nt.shadow.mapSize.set(2048,2048),nt.shadow.camera.left=-9,nt.shadow.camera.right=9,nt.shadow.camera.top=9,nt.shadow.camera.bottom=-9,nt.shadow.normalBias=.008,nt.shadow.bias=-15e-5,nt.shadow.radius=3,nt.shadow.blurSamples=8,c.add(nt),td.init();let rt=new Ko(`#f3eaff`,0,7,3);rt.position.set(-4,7,5),rt.lookAt(0,1,0),c.add(rt);let it=new Ko(`#dfdcff`,0,6,2);it.position.set(4,5,-5),it.lookAt(0,2,0),c.add(it);let at=new Ko(`#ffacd6`,0,7.5,.18);at.position.set(0,1.76,-1.98),at.lookAt(0,1.4,1),w.add(at);let ot=new Ko(`#ffcde7`,0,7.5,.15);ot.position.set(0,.48,2.32),ot.lookAt(0,0,4),w.add(ot);let G=new Kt(1,1,{type:b,samples:4}),st=new qu(s,G);st.addPass(new Ju(c,l));let ct=new Xu(new K(1,1),.32,.65,1);st.addPass(ct),st.addPass(new Qu);let lt=1,ut=1,dt=!1,ft=e.parentElement?.querySelector(`.box-caption`)??null,pt=``,mt=(e,t,n,r)=>{let i=n.toFixed(3);return e&&i!==r&&e.style.setProperty(t,i),i},ht=()=>{lt=e.clientWidth;let t=lt<=760,n=t&&lt>e.clientHeight;ut=t?Math.max(200,e.clientHeight-(n?80:300)):e.clientHeight,n&&(lt=Math.round(lt*.52)),dt=!1;let r=Math.min(window.devicePixelRatio,2,Math.sqrt(24e5/(lt*ut)));s.setPixelRatio(r),st.setPixelRatio(r),s.setSize(lt,ut),st.setSize(lt,ut);let i=Math.min(2048,Math.max(1024,Dt.ceilPowerOfTwo(Math.max(lt,ut)*r)));We.getRenderTarget().width!==i&&We.getRenderTarget().setSize(i,i),s.shadowMap.needsUpdate=!0,Ke=-1/0;let a=lt/ut,o=Math.max(12.8,13.5/a);l.left=-o*a/2,l.right=o*a/2,l.top=o/2,l.bottom=-o/2,l.updateProjectionMatrix()},gt=new ResizeObserver(ht);gt.observe(e),ht();let _t=new fs,vt=new K,yt=!1,bt=!1,xt=null,St=0,Ct=0,wt=!1,Tt=null,Et=.72,kt=.105,At=.16,J=.6,jt=Et/2+At+J,Mt=null,Y=null,Nt=null,X=!1,Pt=(e,t)=>e+Math.random()*(t-e),Ft=()=>(H+137.5+Pt(-24,24))%360,It=e=>{Fe=e,ft&&(ft.style.setProperty(`--hive-caption-accent`,e.css),ft.style.setProperty(`--hive-channel-a`,`hsl(${Math.round((e.hue+118)%360)} 75% 84%)`),ft.style.setProperty(`--hive-channel-b`,`hsl(${Math.round((e.hue+238)%360)} 96% 72%)`))},Lt=e=>{let t=(e%360+360)%360;Math.abs(t-Fe.hue)<.01||It(Ce(t))},Rt=e=>{!ft||Qt.matches||(X=!X,ft.style.setProperty(`--hive-caption-glitch-duration`,`${Math.round(e*1e3)}ms`),ft.dataset.hivePulse=X?`a`:`b`)},zt=e=>{let t=_e[e].accent;return t===`rainbow`?Fe:xe[t]},Bt=(e,t)=>{let n=zt(e);Ee[e].value.copy(n.ink),ce[e].emissive.copy(ve).lerp(n.emission,t),le[e].emissive.copy(ye).lerp(n.emission,t),le[e].color.copy(be).lerp(n.rim,t)},Vt=(e=!0)=>{if(Oe<0||!L[Oe])return;let t=L[Oe];z=ke,Me=1,B=z,Ne=0,V=Pt(.32,1.28),Ie=!1,Re=!1,ze=!1,De[Oe].value=0,ft&&(delete ft.dataset.hivePulse,ft.style.removeProperty(`--hive-caption-glitch-duration`)),e&&(H=328,Pe=Ft(),It(Se),Ee[Oe].value.copy(Se.ink)),t.parent===w&&(t.position.x=t.userData.restX,t.rotation.z=0)},Ht=n=>{if(Y||St>0||t.getState().about||t.getState().contact||!bt||t.getState().paused)return;Nt=null;let r=t.getButtons()[n];if(!r)return;let i=L[n];if(n===Oe&&Vt(!1),Qt.matches){t.getState().onOpen(n,r);return}let a=i.position.clone(),o=i.quaternion.clone();w.updateWorldMatrix(!0,!0),c.attach(i);let s=i.position.clone(),u=s.clone();u.y+=od;let d=l.getWorldDirection(new q),f=l.position.clone().addScaledVector(d,3.5),p=Math.max((l.right-l.left)/de,(l.top-l.bottom)/fe)*1.16;Y={index:n,phase:`out`,time:0,sawDialog:!1,start:s,raised:u,end:f,rotation:i.quaternion.clone(),endRotation:l.quaternion.clone(),startScale:i.scale.clone(),endScale:new q(p,p,p),localPosition:a,localRotation:o,returnTint:0,returnEdgeGlow:.2,returnSurfaceGlow:.09},e.dataset.flight=`true`,t.getState().onHover(n)};t.registerSelect(Ht);let Ut=e=>{let t=s.domElement.getBoundingClientRect();return vt.set((e.clientX-t.left)/lt*2-1,-(e.clientY-t.top)/ut*2+1),_t.setFromCamera(vt,l),_t.intersectObjects(w.children,!0)[0]?.object.userData.index},Wt=e=>{if(Y||St>0||t.getState().about||t.getState().contact||!bt||t.getState().paused)return;Nt=null;let n=Ut(e)??null;if(yt=!0,xt!==n||t.getState().hovered!==n){let r=xt!==n;xt=n,t.getState().onHover(n),r&&n!==null&&e.pointerType!==`touch`&&t.getState().onHoverSound(t.getState().cards[n].id)}},Gt=()=>{yt=!1,xt=null,Vt(!1),Y||t.getState().onHover(null)},qt=null,Jt=e=>{qt={x:e.clientX,y:e.clientY,id:e.pointerId}},Yt=()=>{qt=null},Xt=e=>{let n=qt;if(qt=null,!n||n.id!==e.pointerId||Math.hypot(e.clientX-n.x,e.clientY-n.y)>10||St>0||t.getState().about||t.getState().contact||!bt||t.getState().paused)return;let r=Ut(e);r!==void 0&&Ht(r)};s.domElement.addEventListener(`pointermove`,Wt),s.domElement.addEventListener(`pointerleave`,Gt),s.domElement.addEventListener(`pointerdown`,Jt),s.domElement.addEventListener(`pointercancel`,Yt),s.domElement.addEventListener(`pointerup`,Xt);let Zt=e=>{e.preventDefault(),t.onError()};s.domElement.addEventListener(`webglcontextlost`,Zt);let Qt=window.matchMedia(`(prefers-reduced-motion: reduce)`),$t=0,en=performance.now(),tn=0,nn=()=>{Oe<0||B>=z||(H=Pe,Lt(H))},rn=()=>{en=performance.now(),document.hidden&&(nn(),Vt(!1),yt=!1,xt=null,t.getState().onHover(null))},an=()=>{if(!Qt.matches){ze=!1;return}let e=ze;nn(),Vt(!1),ze=e};document.addEventListener(`visibilitychange`,rn),Qt.addEventListener(`change`,an);let sn=Dt.clamp,cn=e=>1-(1-sn(e,0,1))**4,ln=new q,un=new Ot,dn=new on,fn=e=>{let t=sn(e,0,1);return t*t*(3-2*t)},pn=(t,n)=>{let i=L[t.index],a=r(n,t.phase===`back`?.48:.3,t.phase===`back`?.16/od:0),o=e.clientWidth<=760&&e.clientHeight>e.clientWidth;if(o){let n=fn(a.travel),r=ut+(e.clientHeight-ut)*n;s.domElement.style.setProperty(`height`,`${r}px`,`important`),s.domElement.style.top=`${42*(1-n)}px`;let i=fn(Math.min(1,n*4)),o=`linear-gradient(to bottom,rgba(0,0,0,${i}),#000 8%,#000 72%,rgba(0,0,0,${i}) 100%)`;s.domElement.style.maskImage=o,s.domElement.style.webkitMaskImage=o,l.top=(l.right-l.left)*r/lt/2,l.bottom=-l.top,l.updateProjectionMatrix(),t.endRotation.copy(l.quaternion).multiply(un.setFromAxisAngle(new q(0,0,1),Math.PI/2))}let c=Math.max((l.right-l.left)/(o?fe:de),(l.top-l.bottom)/(o?de:fe))*1.16;t.endScale.setScalar(c),i.position.lerpVectors(t.start,t.raised,a.lift),i.position.lerp(t.end,a.travel),i.position.y+=od*a.arc;let u=(t.index/Math.max(1,L.length-1)-.5)*2,d=64*a.travel**3*(1-a.travel)**3;if(i.position.addScaledVector(v,u*.38*d),t.phase===`out`){let e=sn(n/.12,0,1),t=64*e**3*(1-e)**3;i.position.y-=.07*t,i.position.z-=.045*t}i.quaternion.slerpQuaternions(t.rotation,t.endRotation,a.travel);let f=Math.sin(Math.PI*a.travel)**2,p=t.phase===`back`?-.75:1;dn.set(.045*Math.sin(2*Math.PI*a.travel)*f*p,u*.035*f*p,-u*.055*f*p),un.setFromEuler(dn),i.quaternion.multiply(un);let m=a.travel**(t.phase===`back`?3.5:3);i.scale.lerpVectors(t.startScale,t.endScale,m),i.traverse(e=>{if(!(e instanceof ni))return;let t=o&&a.travel>.25;e.renderOrder=t?100:0;let n=Array.isArray(e.material)?e.material:[e.material];for(let e of n)e.depthTest=!t,e.transparent!==t&&(e.transparent=t,e.needsUpdate=!0)});let h=fn((n-.8)/.2);ce[t.index].color.setScalar(1-h*.75),ce[t.index].emissiveIntensity=.025*(1-h)},mn=e=>{if(!Y||Y.phase!==`covered`||Y.index===e||!L[e])return;let t=Y.index;L[t].traverse(e=>{if(!(e instanceof ni))return;e.renderOrder=0;let t=Array.isArray(e.material)?e.material:[e.material];for(let e of t)e.depthTest=!0,e.transparent=!1,e.needsUpdate=!0});let n=L[t];w.attach(n),n.position.copy(Y.localPosition),n.position.y=1.52,n.quaternion.copy(Y.localRotation),n.scale.setScalar(1),ce[t].color.setScalar(1),ce[t].emissiveIntensity=.025,ce[t].emissive.copy(ve),we[t].value=0,le[t].emissive.copy(ye),le[t].color.copy(be),le[t].emissiveIntensity=.2;let r=L[e],i=r.position.clone();i.y=1.52;let a=r.quaternion.clone();r.position.copy(i),r.scale.setScalar(1),w.updateWorldMatrix(!0,!0),c.attach(r);let o=r.position.clone(),s=o.clone();s.y+=od,Y={...Y,index:e,start:o,raised:s,rotation:r.quaternion.clone(),startScale:new q(1,1,1),localPosition:i,localRotation:a},_e[e].accent!==`base`&&(we[e].value=1,Bt(e,1)),le[e].emissiveIntensity=1.5,pn(Y,1)},hn=-1/0,gn=!1,_n=!1,vn=n=>{$t=requestAnimationFrame(vn);let r=Math.max(0,(n-en)/1e3);if(en=n,document.hidden||gn&&!t.getState().canStart)return;if(t.getState().paused){_n=!0,Y&&(Y.sawDialog=!0,mn(t.getState().projectIndex));return}let i=_n;i&&(_n=!1,yt=!1,xt=null,Vt(Y?.index!==Oe),t.getState().onHover(null)),Y?.phase===`covered`&&Y.sawDialog&&(mn(t.getState().projectIndex),Y.phase=`back`,Y.time=0,Y.localPosition.y=1.52,w.updateWorldMatrix(!0,!1),Y.start.copy(w.localToWorld(Y.localPosition.clone())),Y.raised.copy(Y.start),Y.raised.y+=od,Y.returnTint=_e[Y.index].accent===`base`?0:1,Y.returnEdgeGlow=1.5,Y.returnSurfaceGlow=.09),t.getState().canStart&&(tn+=r);let a=Qt.matches?10:tn*ad.introSpeed,o=Qt.matches?1:fn(tn/ad.cameraFocus),u=Qt.matches?1:fn(tn/1.35),f=Qt.matches?1:fn((tn-.32)/1.08),b=t.getState().about&&!Y;if(b||(dt=!1),b&&St===1&&dt&&Ct===0&&!Nt)return;let x=St;Y||(St=Qt.matches?+!!b:sn(St+(b?1:-1)*r/ad.about,0,1));let S=fn(St),C=fn(St),T=t.getState().contact&&!Y;T&&!wt&&!Qt.matches&&(Tt=-.5),wt=T,(!T||b||Qt.matches)&&(Tt=null),Tt!==null&&(Tt+=r,Tt>=jt+(L.length-1)*kt&&(Tt=null)),Ct=Qt.matches?+!!T:sn(Ct+(T?1:-1)*r/.85,0,1);let E=fn(Ct),D=St>0&&St<1;qe=D?66:30,x!==St&&(St===0||St===1)&&(Ke=-1/0,hn=-1/0);let O=lt<=760,k=(l.right-l.left)*(O?.1:.16),A=1-o;if(l.position.copy(m).multiplyScalar(A*A).addScaledVector(h,2*A*o).addScaledVector(p,o*o),_.lerpVectors(g,d,o),l.lookAt(_),l.position.addScaledVector(v,-k*C),l.position.addScaledVector(v,(l.right-l.left)*(O?.06:.2)*E),O&&l.position.addScaledVector(y,(l.top-l.bottom)*(.2*C-.1*E)),l.zoom=Dt.lerp(O?.7:.54,1.1,o),l.updateProjectionMatrix(),l.updateMatrixWorld(),c.environmentIntensity=.34*u,tt.intensity=.24*u,nt.intensity=1.35*u,rt.intensity=2.8*u,it.intensity=3.3*f,ot.intensity=.32*f,M.emissiveIntensity=.085*f,N.emissiveIntensity=2.35*f,ie.material.opacity=f,pt=mt(ft,`--about-caption-opacity`,1-fn(St/.2),pt),x!==St||Qt.matches){let e=St===1?!0:St===0?!1:null;e!==null&&e!==Mt&&(Mt=e,t.getState().onAboutSettled(e))}se.rotation.x=-ae*cn((a-1)/1.7)*(1-S),bt=a>2.75;let j=Qt.matches?1:1-Math.exp(-ad.hoverResponse*r),ee=Qt.matches?1:1-Math.exp(-ad.glowResponse*r),P=i||Y?null:lt<=760?t.getState().mobileSelected:yt?xt:t.getState().hovered;L.forEach((e,n)=>{if(Y?.index===n)return;let i=cn((a-1.6-n*.055)/.85),o=bt&&St===0&&!t.getState().about&&!t.getState().contact&&P===n,s=L.length>1?n/(L.length-1)*.3:0,c=fn((St-(.32-s))/.2),u=Tt===null?0:Math.max(0,Tt-n*kt),d=sn(u/Et,0,1),p=Math.sin(Math.PI*d)**2,m=fn(u/(Et/2))*(1-fn((u-Et/2-At)/J)),h=Math.max(+!!o,m),g=Dt.lerp(1.52+(o?.32:.26*p),.82,c);n===Oe&&(o&&!ze?(Vt(),Ie=!Qt.matches):!o&&ze&&Vt(!1),ze=o),e.scale.y=Dt.lerp(.35+.65*i,.35,c),a<3?e.position.y=.82+.7*i:e.position.y+=(g-e.position.y)*j;let _=0;if(n===Oe){if(o&&Ie&&Math.abs(e.position.y-g)<=.012&&(Ie=!1,z=ke,Me=1,B=0,Ne=0,Pe=Ft(),Re=!0),o&&B<z&&!Qt.matches){Re&&=(Rt(z),!1);let t=sn(B/z,0,.999),n=Math.min(Ae.length-1,Math.floor(t*Ae.length));_=Ae[n]*Me;let i=R[n];Lt(Pe+je[n]),e.position.x=e.userData.restX+i*.022*_,e.rotation.z=i*.004*_,B=Math.min(z,B+r),B===z&&(H=Pe,Lt(H),Ne=0,V=Pt(.32,1.28))}else e.position.x=e.userData.restX,e.rotation.z=0,o&&!Ie&&!Qt.matches?(Ne+=r,Ne>=V&&(z=Pt(.11,.24),Me=Pt(.46,.76),B=0,Ne=0,Pe=Ft(),Re=!0)):(!o||Qt.matches)&&(B=z,Ne=0,Ie=!1);De[n].value=_}if(ce[n].emissiveIntensity+=(Dt.lerp(.025*f,.09,h)+_*.055-ce[n].emissiveIntensity)*ee,Te[n].value+=(h-Te[n].value)*ee,_e[n].accent!==`base`){let e=we[n];e.value+=(h-e.value)*ee,Bt(n,e.value)}if(le[n].emissiveIntensity+=(Dt.lerp(.2*f,1.5,h)+_*.55-le[n].emissiveIntensity)*ee,St===0&&Ct===0){e.getWorldPosition(ln),ln.y+=.4,ln.project(l);let r=t.getButtons()[n];r&&(r.style.setProperty(`--card-x`,`${(ln.x*.5+.5)*lt}px`),r.style.setProperty(`--card-y`,`${(-ln.y*.5+.5)*ut}px`))}}),at.intensity=(.18+cn((a-1)/2)*2.2)*f*(1-S);let F=!Qt.matches&&yt&&!T?vt.x*.06:0;bt&&!Y&&St===0&&(w.rotation.y+=(F-w.rotation.y)*j*.25),Ye.rotation.y=w.rotation.y,Ye.scale.setScalar(w.scale.x),Xe.uniforms.strength.value=u,et.opacity=.6*f;let te=null;if(Y){if(Y.time+=r,Y.phase===`out`){let e=sn(Y.time/ad.flyOut,0,1);pn(Y,e),e===1&&(te=Y.index,Y.phase=`covered`)}else if(Y.phase===`back`){let t=1-sn(Math.max(0,Y.time-.12)/ad.flyBack,0,1);pn(Y,t);let n=Y.index,r=we[n];if(r.value=Y.returnTint,ce[n].emissiveIntensity=Y.returnSurfaceGlow,le[n].emissiveIntensity=Y.returnEdgeGlow,_e[n].accent!==`base`&&Bt(n,r.value),t===0){let t=L[Y.index];w.attach(t),t.position.copy(Y.localPosition),t.quaternion.copy(Y.localRotation),t.scale.setScalar(1),ce[Y.index].color.setScalar(1),Nt={index:Y.index,time:0,tint:Y.returnTint,edgeGlow:Y.returnEdgeGlow,surfaceGlow:Y.returnSurfaceGlow},Y=null,delete e.dataset.flight,s.domElement.style.removeProperty(`height`),s.domElement.style.removeProperty(`top`),s.domElement.style.removeProperty(`mask-image`),s.domElement.style.removeProperty(`-webkit-mask-image`),ht()}}}if(Nt){Nt.time+=r;let e=fn((Nt.time-ad.returnGlowHold)/ad.returnGlowFade),t=1-e,n=Nt.index;we[n].value=Nt.tint*t,ce[n].emissiveIntensity=.025+(Nt.surfaceGlow-.025)*t,le[n].emissiveIntensity=.2+(Nt.edgeGlow-.2)*t,_e[n].accent!==`base`&&Bt(n,we[n].value),e===1&&(Nt=null)}if(n-hn>=(D?80:40)&&(s.shadowMap.needsUpdate=!0,hn=n),st.render(),dt=b&&St===1&&Ct===0&&!Y&&!Nt,gn||(gn=!0,t.getState().onReady()),te!==null){let e=t.getButtons()[te];e&&t.getState().onOpen(te,e)}};return $t=requestAnimationFrame(vn),()=>{cancelAnimationFrame($t),gt.disconnect(),document.removeEventListener(`visibilitychange`,rn),Qt.removeEventListener(`change`,an),s.domElement.removeEventListener(`pointermove`,Wt),s.domElement.removeEventListener(`pointerleave`,Gt),s.domElement.removeEventListener(`pointerdown`,Jt),s.domElement.removeEventListener(`pointercancel`,Yt),s.domElement.removeEventListener(`pointerup`,Xt),s.domElement.removeEventListener(`webglcontextlost`,Zt);let t=new Set,n=new Set;c.traverse(e=>{e instanceof ni&&(t.add(e.geometry),(Array.isArray(e.material)?e.material:[e.material]).forEach(e=>n.add(e)))}),t.forEach(e=>e.dispose()),n.forEach(e=>e.dispose()),T.forEach(e=>e.dispose()),C.dispose(),We.dispose(),st.dispose(),ct.dispose(),s.dispose(),s.domElement.remove(),delete e.dataset.flight}}export{sd as createProjectBox};